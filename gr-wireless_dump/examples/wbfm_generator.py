...
class wbfm_generator(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "wbfm_generator")
        ...
        self.am_frequency = am_frequency = 125.77e6

        ##################################################
        # Blocks
        ##################################################

        self._am_frequency_range = qtgui.Range(1450e3, 2.5e9, 0.001e6, 125.77e6, 200)
        self._am_frequency_win = qtgui.RangeWidget(self._am_frequency_range, self.set_am_frequency, "AM Freq", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._am_frequency_win)
        ...
        self.uhd_usrp_source_0.set_center_freq(am_frequency, 0)
        self.uhd_usrp_source_0.set_antenna("RX2", 0)
        self.uhd_usrp_source_0.set_normalized_gain(0.75, 0)
    ...
    def get_am_frequency(self):
        return self.am_frequency

    def set_am_frequency(self, am_frequency):
        self.am_frequency = am_frequency
        self.uhd_usrp_source_0.set_center_freq(self.am_frequency, 0)




def main(top_block_cls=wbfm_generator, options=None):
